...
function render(input, out, __component, component, state) {
  ...
  out.w("<div class=\"form-group\"><label for=\"titulo\">Titulo:</label>");

  if (data.livro.titulo) {
    out.w("<input type=\"text\" id=\"titulo\" name=\"titulo\"" +
      marko_attr("value", "" + data.livro.titulo) +
      " placeholder=\"coloque o titulo\" class=\"form-control\">");
  } else {
    out.w("<input type=\"text\" id=\"titulo\" name=\"titulo\" value=\"\" placeholder=\"coloque o titulo\" class=\"form-control\">");
  }

  out.w("</div><div class=\"form-group\"><label for=\"preco\">Preço:</label>");
  ...
  if (data.livro.preco) {
    ...
    out.w("<input type=\"text\" id=\"preco\" name=\"preco\" value=\"\" placeholder=\"150.25\" class=\"form-control\">");
  }

  out.w("</div><div class=\"form-group\"><label for=\"descricao\">Descrição:</label><textarea cols=\"20\" rows=\"10\" id=\"descricao\" name=\"descricao\" placeholder=\"fale sobre o livro\" class=\"form-control\">" +
